...
class DuplicateUpvoteException(HTTPException):
    def __init__(self, message="You have already upvoted this idea"):
        super().__init__(
            status_code=HTTPStatusCodes.BAD_REQUEST.value,
            detail=message,
        )
        self.error_code = ErrorCodes.DUPLICATE_UPVOTE.value
